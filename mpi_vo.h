...
HI_S32 HI_MPI_VO_SetScaleFilter(VO_CHN VoChn, const VO_FILTER_COEF_S *pstScaleCoef);
HI_S32 HI_MPI_VO_GetScaleFilter(VO_CHN VoChn, VO_FILTER_COEF_S *pstScaleCoef);
