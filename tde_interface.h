...
*****************************************************************************/
HI_S32  HI_TDE2_Bitblit(TDE_HANDLE s32Handle, TDE_SURFACE_S *pstSrc, TDE_SURFACE_S *pstDst, TDE_OPT_S *pstOpt);
...
*****************************************************************************/
HI_S32  HI_TDE2_PatternFill(TDE_HANDLE s32Handle, TDE_PATTERN_S *pstPattern,  TDE_SURFACE_S *pstDst, TDE_OPT_S *pstOpt);
...
*****************************************************************************/
HI_S32  HI_TDE2_SolidDraw(TDE_HANDLE s32Handle, TDE_SURFACE_S *pstDst, TDE_RGB_S stFillColor, TDE_OPT_S *pstOpt);
...
*****************************************************************************/
HI_S32  HI_TDE2_Deflicker(TDE_HANDLE s32Handle, TDE_SURFACE_S *pstSrc, TDE_SURFACE_S *pstDst, TDE_DEFLICKER_COEF_S stDfeCoef);
...
*****************************************************************************/
HI_S32  HI_TDE2_EndJob(TDE_HANDLE s32Handle, HI_BOOL bBlock, HI_U32 u32TimeOut);
...
*****************************************************************************/
HI_S32  HI_TDE2_WaitForDone(HI_VOID);
