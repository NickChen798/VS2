...
HI_S32 HI_MPI_VENC_SetJpegSnapQp(VENC_CHN VeChn, VENC_JPEG_SNAP_QP_S* pstSnapQp);
HI_S32 HI_MPI_VENC_GetJpegSnapQp(VENC_CHN VeChn, VENC_JPEG_SNAP_QP_S* pstSnapQp);
